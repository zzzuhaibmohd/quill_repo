...
contract MockGovToken is ERC20("MockGovToken", "MGToken"), Ownable {
    ...
    function delegateBySigPOC(
        address delegatee
    ) external {
        //Assuming all the inputs passed with respect to orginal 'delegateBySig'
        //Since foundry does not have a way to sign a signTypedData and splitSignature like ethers.js for hardhat
